        ...
        <div className={cn('relative', className)}>
            ...
            <div
                ...
                className={cn(
                    ...
                    'empty:before:content-[attr(data-placeholder)] empty:before:text-muted-foreground empty:before:pointer-events-none empty:before:block empty:before:leading-normal',
